...
!
!----------------------------------------------------------------------------
SUBROUTINE s_psi_new( lda, n, m, psi, spsi, ibnd_start, ibnd_end )
  !----------------------------------------------------------------------------
  !
  ...
  !
  INTEGER,INTENT(IN)         :: lda, n, m, ibnd_start, ibnd_end
  COMPLEX(DP), INTENT(INOUT) :: psi(lda*npol,m), spsi(lda*npol,m)
  !
  ! ... initialize  spsi
  !
  spsi = (0.0,0.0)
  spsi(1:lda*npol, ibnd_start:ibnd_end) = psi(1:lda*npol,ibnd_start:ibnd_end)
  !
